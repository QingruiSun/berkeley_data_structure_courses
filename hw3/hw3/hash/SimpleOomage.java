...
public class SimpleOomage implements Oomage {
    ...
    public boolean equals(Object o) {
        ...
        SimpleOomage oSimpleOomage = (SimpleOomage) o;
        if ((this.red == oSimpleOomage.red)
                && (this.blue == oSimpleOomage.blue) && (this.green == oSimpleOomage.green)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        if (!USE_PERFECT_HASH) {
            ...
            int perfectHashcode = (this.red / 5 * 52 * 52)
                    + (this.green / 5 * 52) + (this.blue / 5);
            return perfectHashcode;
        }
    }
